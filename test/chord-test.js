...
tape("multichord works for all 0 matrix", function(test) {
  emptyMatrix = [
  ...
  var multichord = d3.multichord().sortSubgroups(function(a, b) { return b - a; });
  multichord.padAngle(0.05);
  var chords = multichord(emptyMatrix);
  test.inDelta(chords.groups, [{
    index: 0, startAngle: 0, endAngle: 0, value: {in: 0, out: 0}}, {
    index: 1, startAngle: 1.5707963267948966, endAngle: 1.5707963267948966, value: {in: 0, out: 0}}, {
    index: 2, startAngle: 3.141592653589793, endAngle: 3.141592653589793, value: {in: 0, out: 0}}, {
    index: 3, startAngle: 4.71238898038469, endAngle: 4.71238898038469, value: {in: 0, out: 0}}
  ]);
  test.end();
})
